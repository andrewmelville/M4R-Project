...
class MeanReversion():
    ...
    def back_test(self, currency_returns, noisy_commods_returns, noise, chunk_size, lookback):  
        ...
        for commod in noisy_commods_returns:   
            self.daily_prices[commod] = np.exp([i for i in noisy_commods_returns[commod]]).cumprod()
        ...
        PL_curve_df['Optimal'] = self.optimum_trade(currency_returns, noisy_commods_returns, noise)
    ...
    def optimum_trade(self, currency_returns, noisy_commods_returns, noise):
        ...
        # Use true noise series as residuals
