...
class MeanReversion():
    ...
    def optimum_trade(self, currency_returns, noisy_commods_returns, signal_commods_returns):
        ...
        for i, commod in enumerate(noisy_commods_returns.columns):
            
            # Compute residuals for each commodity to be used in signal generation
            self.residuals_df[commod] = noisy_commods_returns[commod] - signal_commods_returns[commod]
