...
class MeanReversion():
    ...
    def optimum_trade(self, currency_returns, signal_commods_returns, chunk_size = 30, lookback = 10):
        ...
        self.trade(currency_returns, signal_commods_returns, chunk_size = chunk_size, lookback = lookback)
    ...
    def noisy_trade(self, currency_returns, noisy_commods_returns, chunk_size = 30, lookback = 10):
        ...
        self.trade(currency_returns, noisy_commods_returns, chunk_size = chunk_size, lookback = lookback)
